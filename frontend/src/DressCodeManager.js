...
function DressCodeManager({ adminData }) {
  ...
  const fetchDressCodes = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/admin/dress-codes/${adminData.institute_id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/admin/dress-code/upload`, formData);
  ...
  const handleDelete = async (dressCodeId) => {
    ...
    try {
      const response = await axios.delete(`${process.env.REACT_APP_API_URL}/admin/dress-code/${dressCodeId}`);
