...
function ForgotPassword() {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/admin/send-otp`, formData);
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/admin/verify-otp`, formData);
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/admin/reset-password-with-otp`, formData);
