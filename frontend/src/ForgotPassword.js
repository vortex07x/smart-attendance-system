...
function ForgotPassword() {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:8000/admin/send-otp', formData);
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:8000/admin/verify-otp', formData);
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:8000/admin/reset-password-with-otp', formData);
